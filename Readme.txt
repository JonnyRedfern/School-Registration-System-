...
//Add a new student
	...
	will give feedback CONFIRMED if worked
...
//Add transcript for a student
	...
	will give feedback DUPLICATE if student has already passed class
...
//Add to class will either be enlisted rejected or added to waiting list. If student doesn't have pre requisite he/she will not be accepted
	...
	will give feedback CONFIRMED if worked
	will give feedback DUPLICATE if student is already in waiting list or class
	will give feedback NO PREREQ if student is missing pre requisite

//Show status of student

	STATUS studentNum
	
	will give feedback of classes passed, currently enrolled in, currently on waiting list for, and failed
